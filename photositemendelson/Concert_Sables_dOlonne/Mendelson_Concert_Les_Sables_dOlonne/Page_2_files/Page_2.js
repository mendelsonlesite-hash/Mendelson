...
{return IWCreatePhotocast("http://mendelson.free.fr/Photositemendelson/Concert_Sables_dOlonne/Mendelson_Concert_Les_Sables_dOlonne/Page_2_files/rss.xml",false);}
function initializeMediaStream_id2()
{createMediaStream_id2().load('http://mendelson.free.fr/Photositemendelson/Concert_Sables_dOlonne/Mendelson_Concert_Les_Sables_dOlonne',function(imageStream)
{var entryCount=imageStream.length;var headerView=widgets['widget1'];headerView.setPreferenceForKey(imageStream.length,'entryCount');NotificationCenter.postNotification(new IWNotification('SetPage','id2',{pageIndex:0}));});}
function layoutMediaGrid_id2(range)
{createMediaStream_id2().load('http://mendelson.free.fr/Photositemendelson/Concert_Sables_dOlonne/Mendelson_Concert_Les_Sables_dOlonne',function(imageStream)
{if(range==null)
{range=new IWRange(0,imageStream.length);}
IWLayoutPhotoGrid('id2',new IWPhotoGridLayout(2,new IWSize(278,278),new IWSize(278,0),new IWSize(306,293),27,27,0,new IWSize(2,2)),new IWEmptyStroke(),imageStream,range,null,null,1.000000,{backgroundColor:'rgb(255, 255, 255)',reflectionHeight:0,reflectionOffset:2,captionHeight:0,fullScreen:1,transitionIndex:2},'Media/slideshow.html','widget1','widget2','widget3')});}
