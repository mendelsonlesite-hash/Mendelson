			...
			<head>
				<xsl:choose>
					<xsl:when test="kml:kml">
						<title>Emplacements - Plan de site - Mendelson &#8211; Le site</title>
					</xsl:when>
					<xsl:otherwise>
						<title>Sitemap XML - Mendelson &#8211; Le site</title>
					</xsl:otherwise>
				</xsl:choose>
				...
				<xsl:choose>
					<xsl:when test="kml:kml">
						...
						<div id="content">
							...
							<p class="expl">
								<a href="https://mendelson.fr/sitemap_index.xml">&#8592; Index du plan de site</a>							</p>
...
<!-- Cached page generated by WP-Super-Cache on 2026-04-07 16:35:11 -->
